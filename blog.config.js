...
const BLOG = {
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.christinejourney.com', // 网站地址
  ...
  POSTS_SHARE_SERVICES: process.env.NEXT_PUBLIC_POST_SHARE_SERVICES || 'link,wechat,whatsapp,telegram,line,facebook', // 分享的服務，按顺序显示,逗号隔开
